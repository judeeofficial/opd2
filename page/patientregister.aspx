...
<body>
  <center>  <P1>บันทึกข้อมูลคนไข้</P1> </center>
  ...
  <tr class="active">
      ...
      <td class="active" style="width: 230px">
          วัน/เดือน/ปีเกิด</td>
        <td class="active" style="width: 342px">
            <asp:ImageButton ID="btbirthday" runat="server" Height="77px" ImageUrl="~/image/image3.png" Width="88px" OnClick="btbirthday_Click" />
