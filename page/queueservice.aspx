<%@ Page Title="" Language="C#" MasterPageFile="~/page.master" AutoEventWireup="true" CodeFile="queueservice.aspx.cs" Inherits="page_msstaff" %>
...
<link rel="stylesheet" href="../css/style.css">
  ...
  <center>  
      <asp:GridView ID="GridView1" runat="server" CellPadding="4" ForeColor="#333333" GridLines="None" Height="245px" Width="861px" AutoGenerateColumns="False" DataSourceID="SqlDataSource1" OnSelectedIndexChanged="GridView1_SelectedIndexChanged">
      ...
      <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:Connectionstring %>" SelectCommand="SELECT queue.sequence_queue,
                                                                                                                                        ...
                                                                                                                                        WHERE Patient.Patient_id = queue.Patient_id"></asp:SqlDataSource>
    </center>
