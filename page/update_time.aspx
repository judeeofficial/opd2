<%@ Page Title="" Language="C#" MasterPageFile="~/page.master" AutoEventWireup="true" CodeFile="update_time.aspx.cs" Inherits="page_update_time" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
       <link href="../css/bootstrap.min.css" rel="stylesheet">
<link rel="stylesheet" href="../css/style.css">
      <center>
          <k1>เลื่อนการจัดตารางเวรแพทย์ประจำเดือน <asp:Label ID="lblmonth" runat="server"></asp:Label></k1>
</center> 
...
<br />
          ...
          <tr>
            <td class="info" colspan="2">
                <asp:Button ID="btnsubmit" class="btn btn-default" runat="server" Text="Submit" Width="238px" OnClick="btnsubmit_Click" />
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <asp:Button ID="Button1" class="btn btn-default" runat="server" Height="36px" OnClick="Button1_Click" Text="Black" Width="266px" />
              </td>
